...
class SecurityGuardController extends Controller
{
    public function index()
    {
      ...
      return view('company.security_guard.index',$data);
    }

    public function create()
{ 
    $view =  view('company.security_guard.create')->render(); 
...
{ 
    ...
    $security_guard->date_of_birth = $request->date_of_birth; 
...
public function list(Request $request)
{
    ...
    foreach ($result as $row) {
        ...
        $showdetails = route('company.show.security.guard', $row->id);
        $edit = route('company.edit.security.guard', $row->id);
        $delete = route('company.delete.security.guard', $row->id);
        ...
        $action = '<div class=" custom_dropdown">
          ...
          $status = '<div class="form-check form-switch">
                        <input class="form-check-input shadow-none" type="checkbox" id="flexSwitchCheckDefault" onclick="statusRow(this,`'.route('company.security.status',[$row->id]).'`)" '.$checked.'>
                    </div>';
...
{ 
    ...
    $view =  view('company.security_guard.edit',$data)->render(); 
...
{ 
    $data['uinfo'] = SecurityGuard::where('id',$id)->first(); 
    $view =  view('company.security_guard.view',$data)->render(); 
