...
class VehicleOwnerController extends Controller
{
    public function index()
    {
        ...
        return view('vendor.vehicle_owner.index', $data);
    }

    public function create()
    {
        return  view('vendor.vehicle_owner.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $vehicle_owner->vendor_id = $request->user()->id;
    ...
    public function list(Request $request)
    {
        ...
        foreach ($result as $row) {
            ...
            $view = route('vendor.show.vehicle.owner', $row->id);
            $edit = route('vendor.edit.vehicle.owner', $row->id);
            $delete = route('vendor.delete.vehicle.owner', $row->id);
    ...
    public function edit($id)
    {
        ...
        return  view('vendor.vehicle_owner.edit', $data);
    }

    public function show($id)
    {
        $data['uinfo'] = VehicleOwner::where('id', $id)->first();
        return  view('vendor.vehicle_owner.view', $data);
    }
