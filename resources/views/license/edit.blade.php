<form method="post" class="" id="step_one" onsubmit="form_submit1(this);return false;" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="mb-4">
        <div class="p-4">
            <h3 class="modal-title mb-3 text-center" id="">Edit License</h3>
            <div class="row">
                <!-- License Number -->
                <div class="col-6 mb-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="license_number" value="{{ $uinfo->license_number }}">
                        </div>
                    </div>
                </div>         
                <!-- Issue Date -->
                ...
                <div class="col-6 mb-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="date" class="form-control" name="valide_upto" value="{{ $uinfo->valide_upto }}">
                        </div>
                    </div>
                </div> 
