            ...
            <div class="card-body text-center px-4 py-4">
                <form action="" id="employeeForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select class="form-select shadow-none border-0 mb-4" id="companie_id" name="companie_id" onchange="getState(this); return false;">
                                <option selected disabled>Select Companie</option>
                                @foreach ($companies as $companie)
                                <option @if($companie->id == $employee->company_id) selected @endif value="{{ $companie->id }}">{{ $companie->name }}</option>
                                @endforeach
                            </select>
                        </div>
