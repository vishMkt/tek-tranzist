            ...
            <div class="card-body text-center px-4 py-4">
                <form action="" id="employeeForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class=" gap-3">
                                <span class="input-group-text bg_gray border-0 gap-2 font_15_medium"
                                    ...
                                    <input readonly type="tel" class="form-control" name="mobile" id="phone" placeholder="Mobile Number" style="border-radius: 8px;" value="{{ $employee->mobile }}"> 
                                </span> 
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <input readonly type="text" name="age" id="age"
                                class="form-control shadow-none  border-0  mb-4" value="{{ $employee->age }}" placeholder="Age">
                        </div>
                        <div class="col-md-6"> 
                            <select disabled class="form-select shadow-none border-0 mb-4" id="country" name="country" onchange="getstate(this); return false;">
                        ...
                        <div class="col-md-6">
                            <select disabled class="form-select shadow-none border-0 mb-4" id="state" name="state" onchange="getCities(this); return false;">
                        ...
                        <div class="col-md-6">
                            <select disabled class="form-select shadow-none border-0 mb-4" id="city" name="city">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select disabled name="status" id="status" class="form-control mb-4">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#employeeForm').on('submit', function(e) {
                ...
                $.ajax({
                    url: '{{ route('employee.update') }}', // Replace with your route
                    method: 'POST',
