...
<div id="content">
    <div class=" d-flex flex-wrap justify-content-between mb-4">
        <h5 class="top_title">Edit Vehicle</h5>
    </div>
                    ...
                    <div class="p-4">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="license_plate" id="license_plate" class="form-control" value="{{ $uinfo->license_plate }}"> 
                                    </div>
                                </div> 
                                      <!-- Make -->
                                <div class="col-6 mb-4">
                                    <div class="form-group">
                                        ...
                                        @foreach($makes as $make)
                                            <option @if($make->id == $uinfo->make) selected @endif value="{{ $make->id }}">{{ $make->name }}</option>
                                        @endforeach
                                    </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-6 mb-4">
                            <div class="form-group">
                                ...
                                @foreach($models as $model)
                                    <option @if($model->id == $uinfo->model) selected @endif value="{{ $model->id }}">{{ $model->name }}</option>
                                @endforeach
                            </select>
                                </div>
                            </div>
                            ...
                            <div class="col-6 mb-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="month" class="form-control" name="year" value="{{ $uinfo->year }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 mb-4">
                            ...
                            <div class="form-group">
                                ...
                                <select name="vendor" id="vendors" class="form-control">
                                    ...
                                    @foreach ($vendors as $vendor)
                                        <option @if($uinfo->vendor_id == $vendor->id) selected @endif value="{{ $vendor->id }}">{{ $vendor->firstname }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="puc_certificate_number" value="{{ $puc->puc_certificate_number }}">
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" class="form-control" name="puc_issue_date" value="{{ $puc->puc_issue_date }}">
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="col-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="date" class="form-control" name="puc_expiry_date" value="{{ $puc->puc_expiry_date }}">
                                </div>
                            </div>
                        </div>  
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <label class="mb-2" for="drivers" >Front Image<sup class="text-danger">*</sup></label> 
                                    <input type="hidden" id="imageId" name="image_id" value="{{ $puc->front_image }}">
            ...
            <div class="col-md-12">
                            <div class="row">
                                ...
                                <label class="mb-2" for="drivers" >Back Image<sup class="text-danger">*</sup></label> 
                                    <input type="hidden" id="imageId_back" name="image_id_back" value="{{ $puc->back_image }}">
                                    <input type="file" name="file_back" id="imageUrl_back" class="form-control mb-4"
                                        onchange="uploadbackImage('#step_one')">

                                </div>
                                <div class="col-md-2">
                                    <img src="{{ asset(@$puc->ImageBack->file_path) }}" alt="Uploaded Image" id="uploadedImage_back" class="img-thumbnail"
                                        style="width:80px; height:80px;">
                ...
                <div class="col-6 mb-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="policy_number" value="{{ $insurance->policy_number }}">
                        </div>
                    </div>
                </div>         
                <!-- Provider -->
                ...
                <div class="col-6 mb-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="date" class="form-control" name="issue_date"  value="{{ $insurance->issue_date }}">
                        </div>
                    </div>
                </div>  
                ...
                <div class="col-6 mb-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="date" class="form-control" name="expiry_date"  value="{{ $insurance->expiry_date }}">
                        </div>
                    </div>
                </div> 
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-10">
                            <label class="mb-2" for="drivers" >Front Image<sup class="text-danger">*</sup></label> 
                                <input type="hidden" id="imageId_front_insurance" name="image_id_front_insurance" value="{{ $insurance->front_image }}">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-10">
                                <label class="mb-2" for="drivers" >Back Image<sup class="text-danger">*</sup></label> 
                                    <input type="hidden" id="imageId_back_insurance" name="image_id_back_insurance" value="{{ $insurance->back_image }}">
...
function uploadbackInsuranceImage(form) {   
    $(form).find('#uploadLoader_back_insurance').show();
      ...
      $.ajax({
          type: "POST",
          url: '{{ route("image.upload_back_insurance") }}', 
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          }, 
          contentType: false,       
...
function uploadFrontInsuranceImage(form) {   
    $(form).find('#uploadLoader_front_insurance').show();
      ...
      $.ajax({
          type: "POST",
          url: '{{ route("image.upload_front_insurance") }}', 
          headers: {
              'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
          }, 
          contentType: false,       
