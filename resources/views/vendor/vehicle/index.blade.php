...
@section('content')
                ...
                <div class=" d-flex flex-wrap justify-content-between mb-4">
                    ...
                    <a href="{{ route('vendor.create.vehicle')}}" class="ctn_button d-flex flex-wrap align-items-center justify-content-center border-0" >
 ...
 function add(e){
     ...
     $('#modal-md .modal-content').html('');
         ...
         $.ajax({
             ...
             url:"{{ route('vendor.create.vehicle') }}",
             type:"POST",
             data:{},
             dataType:"json",
