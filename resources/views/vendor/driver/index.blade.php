...
<div class=" d-flex flex-wrap justify-content-between mb-4">
    ...
    <a href="{{ route('vendor.create.driver') }}"
            class="ctn_button d-flex flex-wrap align-items-center justify-content-center border-0">
    ...
    $.ajax({
        ...
        function add(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('vendor.create.driver') }}",
                type: "POST",
                data: {},
                dataType: "json",
                success: function(data) {
