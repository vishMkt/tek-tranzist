...
@section('content')
    <div id="content">
        ...
        <div class=" d-flex flex-wrap justify-content-between mb-4">
            <h5 class="top_title">Edit Driver</h5>
        </div>
        <div class="card border-0 mt-4 rounded-3">
            ...
            <form method="post" class="" id="step_one" onsubmit="form_submit1(this);return false;" autocomplete="off"
                        ...
                        <div class="col-6 mb-4">
                          ...
                          <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="adhar_card" value="{{ $uinfo->adhar_card }}">
                                </div>
                            </div>
                        </div>
                         <!-- Pan Card -->
                         <div class="col-md-6 mb-4">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="pan_card"  value="{{ $uinfo->pan_card }}">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" name="license_number" value="{{ $license->license_number }}">
                        </div>
                    </div>
                </div>         
                ...
                <div class="col-6 mb-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="date" class="form-control" name="valide_upto" value="{{ $license->valide_upto }}">
                        </div>
                    </div>
                </div> 
            ...
            <div class="col-md-12">
                            <div class="row">
                                ...
                                <label class="mb-2" for="drivers" >Front Image<sup class="text-danger">*</sup></label> 
                                    <input type="hidden" id="imageId" name="image_id" value="{{ $license->front_image }}">
            ...
            <div class="col-md-12">
                            <div class="row">
                                ...
                                <label class="mb-2" for="drivers" >Back Image<sup class="text-danger">*</sup></label> 
                                    <input type="hidden" id="imageId_back" name="image_id_back" value="{{ $license->back_image }}">
...
@section('page-script')
	...
	$.ajax({  
	  url :"{{ route('vendor.update.driver') }}",  
	  method:"POST",  
	  dataType:"json",  
	  data:$(e).serialize(),
	   success: function(data){ 
            if(data.status==1){
              ...
              $(e).find('.st_loader').hide();
                ...
                window.location.href = "{{ route('vendor.driver') }}";
...
function uploadattachmentImage(form) {   
  $(form).find('#uploadLoader_attachment').show();
    ...
    $.ajax({
        type: "POST",
        url: '{{ route("vendor.image.upload_attachment") }}', 
        headers: {
            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        }, 
        contentType: false,       
